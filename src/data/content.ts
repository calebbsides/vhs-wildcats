...
export const content = {
  ...
  coaches: [
    ...
    { name: "J.T. Black", title: "Assistamt Head Coach", units: ["Offensive Line"], photo: "/coaches/placeholder.svg" },
    { name: "Keith Barefield", title: "Offensive Coordinator", units: ["Quarterbacks"], photo: "/coaches/placeholder.svg" },
    { name: "LaBrandon Hudson", title: "Defensive Coordinator", units: ["Safties"], photo: "/coaches/placeholder.svg" },
    { name: "Jay Rome", title: "Co-Offensive Coordinator", units: ["Wide Receivers"], photo: "/coaches/placeholder.svg" },
    { name: "Daniel Brinson", title: "Offensive Line", units: ["Offensive Line"], photo: "/coaches/placeholder.svg" },
    { name: "Chris Anderson", title: "Special Teams Coordinator", units: ["Running Backs"], photo: "/coaches/placeholder.svg" },
    { name: "Andrew Christie", title: "Strength & Conditioning Coordinator", units: ["Outside Line Backers"], photo: "/coaches/placeholder.svg" },
    { name: "Taurean Batten", title: "Defensive Line", units: ["Defensive Line"], photo: "/coaches/placeholder.svg" },
    { name: "Tomarcio Reese", title: "Asst. Strength & Conditioning Coordinator", units: ["Inside Line Backers"], photo: "/coaches/placeholder.svg" },
    { name: "Earl Chaptman", title: "Tight Ends", units: ["Tight Ends"], photo: "/coaches/placeholder.svg" },
    { name: "Christian Tutt", title: "Cornerbacks", units: ["Cornerbacks"], photo: "/coaches/placeholder.svg" },
    { name: "Antonio Foster", title: "9th Grade Head Coach", photo: "/coaches/placeholder.svg" },
    { name: "Jahlil Taylor", title: "9th Grade Defensive Line", photo: "/coaches/placeholder.svg" },
    { name: "Brandon Bennett", title: "9th Grade Offensive Line", photo: "/coaches/placeholder.svg" },
    { name: "Carter Brogdan", title: "9th Grade Quarterbacks", photo: "/coaches/placeholder.svg" },
    { name: "Andrel Lane", title: "9th Grade Defensive Backs", photo: "/coaches/placeholder.svg" },
    { name: "Clay Brindger", title: "Director of Football Operations", photo: "/coaches/placeholder.svg" },
    { name: "Ben Sigers", title: "Athletic Trainer", photo: "/coaches/placeholder.svg" },
    { name: "Justin Crenshaw", title: "Team Chaplain", photo: "/coaches/placeholder.svg" },
  ],
