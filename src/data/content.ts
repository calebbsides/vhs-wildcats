...
export const content = {
  ...
  coaches: [
    ...
    { name: "Coach Name", title: "Offensive Coordinator", units: ["Offense", "Quarterbacks"], photo: "/coaches/placeholder.jpeg" },
    { name: "Coach Name", title: "Defensive Coordinator", units: ["Defense", "Linebackers"], photo: "/coaches/placeholder.jpeg" },
    { name: "Coach Name", title: "Special Teams Coordinator", units: ["Special Teams"], photo: "/coaches/placeholder.jpeg" },
    { name: "Coach Name", title: "Wide Receivers", units: ["Offense"], photo: "/coaches/placeholder.jpeg" },
    { name: "Coach Name", title: "Offensive Line", units: ["Offense"], photo: "/coaches/placeholder.jpeg" },
    { name: "Coach Name", title: "Defensive Backs", units: ["Defense"], photo: "/coaches/placeholder.jpeg" },
    { name: "Coach Name", title: "Strength & Conditioning", photo: "/coaches/placeholder.jpeg" },
  ],
