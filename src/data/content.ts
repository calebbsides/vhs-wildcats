...
export const content = {
  ...
  coaches: [
    ...
    { name: "J.T. Black", title: "Assistamt Head Coach", units: ["Offensive Line"] },
    { name: "Keith Barefield", title: "Offensive Coordinator", units: ["Quarterbacks"] },
    { name: "LaBrandon Hudson", title: "Defensive Coordinator", units: ["Safties"] },
    { name: "Jay Rome", title: "Co-Offensive Coordinator", units: ["Wide Receivers"] },
    { name: "Daniel Brinson", title: "Offensive Line", units: ["Offensive Line"] },
    { name: "Chris Anderson", title: "Special Teams Coordinator", units: ["Running Backs"] },
    { name: "Andrew Christie", title: "Strength & Conditioning Coordinator", units: ["Outside Line Backers"] },
    { name: "Taurean Batten", title: "Defensive Line", units: ["Defensive Line"] },
    { name: "Tomarcio Reese", title: "Asst. Strength & Conditioning Coordinator", units: ["Inside Line Backers"] },
    { name: "Earl Chaptman", title: "Tight Ends", units: ["Tight Ends"] },
    { name: "Christian Tutt", title: "Cornerbacks", units: ["Cornerbacks"] },
    { name: "Antonio Foster", title: "9th Grade Head Coach" },
    { name: "Jahlil Taylor", title: "9th Grade Defensive Line" },
    { name: "Brandon Bennett", title: "9th Grade Offensive Line" },
    { name: "Carter Brogdan", title: "9th Grade Quarterbacks" },
    { name: "Andrel Lane", title: "9th Grade Defensive Backs" },
    { name: "Clay Brindger", title: "Director of Football Operations" },
    { name: "Ben Sigers", title: "Athletic Trainer" },
    { name: "Justin Crenshaw", title: "Team Chaplain" },
  ],
